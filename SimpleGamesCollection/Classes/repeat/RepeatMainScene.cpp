...
RepeatMainScene::RepeatMainScene() {
  gameOver = false;
}
...
Scene* RepeatMainScene::createScene(std::shared_ptr<SixCatsLogger> inC6) {

  RepeatMainScene *pRet = new(std::nothrow) RepeatMainScene();
  if (pRet == nullptr) {
    return nullptr;
  }
...
bool RepeatMainScene::initBackground() {
...
bool RepeatMainScene::initGameNode() {
...
bool RepeatMainScene::initGameOverImage() {
  // --- victory image
...
bool RepeatMainScene::initGameOverMenu() {
  ...
  ccMenuCallback mcbs[itemsCount] = {CC_CALLBACK_1(RepeatMainScene::mcBackToMain, this),
                                     CC_CALLBACK_1(RepeatMainScene::mcTryAgain, this)
  };
...
bool RepeatMainScene::initKeyboardProcessing() {
  // keyboard processing
  EventListenerKeyboard* sceneKeyboardListener = EventListenerKeyboard::create();
  sceneKeyboardListener->onKeyPressed = CC_CALLBACK_2(RepeatMainScene::onKeyPressedScene, this);
...
void RepeatMainScene::mcBackToMain(cocos2d::Ref *pSender) {
  Director::getInstance()->popToRootScene();
}

// . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .

void RepeatMainScene::mcTryAgain(cocos2d::Ref *pSender) {
...
void RepeatMainScene::processGameOver(const bool gameResult) {
  C6_D1(c6, "here");
...
void RepeatMainScene::onKeyPressedScene(EventKeyboard::KeyCode keyCode, Event *) {
