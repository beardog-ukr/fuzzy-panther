...
bool GameEndScene::initBackground() {
  ...
  // rt->setAnchorPoint(Vec2(0, 0));
  // rt->setPosition(Vec2(0, 0));
  // addChild(rt, ZO_scene_background);
...
bool GameEndScene::initMenuBackground() {
  ...
  const string failImageName = "asteroids/deadGame.png";
  const string victoryImageName = "asteroids/victoryGame.png";
